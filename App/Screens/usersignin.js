...
const Login = ({ navigation, route }) => {
    ...
    const handleLogin = async () => {
        if (values.mobile === '' || values.password === '') {
          ...
          const resp = await api.post('login', { mobile: values.mobile, password: values.password });
        ...
        <>
            <View style={styles.main}>
                <View style={styles.container}>
                    ...
                    <View>
                        < Text style={{ fontWeight: '800', padding: 2, color: '#000', fontSize: 22, marginTop: 15 }}>Sign In as {vtype == 1 ? 'Priest' : 'User'}
                        </Text>
                ...
                <View style={styles.dont}>
                    < TouchableOpacity onPress={() => vtype == 1 ? navigation.navigate('Signup', { vtype: 2 }) : navigation.navigate('Signup', { vtype: 1 })} >
                        < Text style={{
                            color: '#fff',
                            fontSize: 16,
                            fontWeight: '600',
